...
$nombre_plat = $_POST["nombre_plat"];
$nom_plat = $_POST["nom_plat"];
$commentaire = mysqli_real_escape_string($connexion, $_POST["commentaire"]);


// Insertion d'une nouvelle commande dans la table "commandes"
$sql = "INSERT INTO commandes (telephone, date_commande, heure_commande,nombre_plat,nom_plat,commentaire) VALUES ('$telephone', '$date_commande', '$heure_commande', '$nombre_plat','$nom_plat','$commentaire')";
...
if ($connexion->query($sql) === TRUE){
	...
	echo "Une erreur est survenue lors de l'ajout de la commande : " . $connexion->error;
}
