...
<script>
  ...
  <!-- End Google Map -->
    ...
    //recupération des données du formaulaire
    $nom = $_POST["nom"];
    $email =$_POST["email"];
    ...
    //Insertion d'un nouveau cliant dans la table client
    $sql ="INSERT INTO clients (nom,email,telephone,adresse,code_postal) VALUES ('$nom','$email','$telephone','$adresse','$code_postal')";

    //Execution de la requete SQL
    if ($connexion->query($sql)==TRUE)
    {
        echo "<script> alert ('Le client a été ajoutée avec succès.');</script>";
    }
    else 
    {
        echo "Une erreur est survenue lors de l'ajout du client :" . $connexion->error;
    }
